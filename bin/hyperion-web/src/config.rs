...
pub struct WebSection {
    ...
    pub listen: String,
    /// Path to the hyperion-agent Unix socket.
...
impl Default for WebSection {
    fn default() -> Self {
        Self {
            ...
            agent_socket: PathBuf::from("/run/hyperion.sock"),
            admin_user_file: PathBuf::from("/etc/hyperion/web-admin.json"),
            session_key_file: PathBuf::from("/etc/hyperion/web-session.key"),
            csrf_key_file: PathBuf::from("/etc/hyperion/web-csrf.key"),
...
mod tests {
    ...
    fn defaults_are_sane() {
        ...
        assert_eq!(c.web.session_cookie_name, "hyperion_session");
    }
